...
class RoleFormProcessor implements EventSubscriberInterface
{
    ...
    public function __construct(RouterInterface $router, NotificationPoolInterface $notificationPool, RoleService $roleService)
    {
        $this->router = $router;
    ...
    {
        // TODO: When we have role versioning, save draft here. For now, processSaveRole takes care of saving. Follow-up: EZP-24701
    ...
    {
        // TODO: This will delete the role completely. Must delete only the draft. Follow-up: EZP-24701
